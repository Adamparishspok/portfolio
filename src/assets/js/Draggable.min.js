...
!(function (e, t) {
  ...
  function fa(e, t) {
    var n = ye.createElementNS
      ? ye.createElementNS((t || 'http://www.w3.org/1999/xhtml').replace(/^https/, 'http'), e)
      : ye.createElement(e);
  ...
  function Ka(e, t) {
    ...
    return Math.max(
      0,
      Qe(e) ? Math.max(ve[o], l[o]) - (me['inner' + n] || ve[r] || l[r]) : e[o] - e[r]
    );
  }
  function La(e, t) {
    var n = Ka(e, 'x'),
          ...
          (r &&
            ...
            (r && !e) ||
              ...
              (v = Math.max(0, i.scrollWidth - i.clientWidth)) &&
                (v += parseFloat(t.paddingLeft) + (R ? parseFloat(t.paddingRight) : 0))),
  ...
  function Draggable(h, p) {
      ...
      if (q.autoScroll && q.isDragging && (te || Y)) {
        ...
        for (
          ...
          ((t = (n = Qe(c.parentNode)) ? We : c.parentNode),
            ...
            n &&
              (a || l) &&
              (me.scrollTo(t.scrollLeft, t.scrollTop), he(q.pointerX + a, q.pointerY + l)),
            (c = t));
      }
      if (Y) {
        var p = q.x,
          ...
          : f
            ...
            : W
              ? (U && ((q.deltaY = u - parseFloat(se.y)), (se.y = u + 'px')),
                ...
                se.renderTransform(1, se))
              : (U && ((q.deltaY = u - parseFloat(h.style.top || 0)), (h.style.top = u + 'px')),
                V && ((q.deltaX = p - parseFloat(h.style.left || 0)), (h.style.left = p + 'px'))),
          !g ||
            e ||
            z ||
        ...
        p.liveSnap &&
          ...
          Q
            ...
            : n.points
              ...
              : (V && (A = Bh(o ? n : n.x || n.left || n.scrollLeft, L, E, f ? -1 : 1)),
    ...
    function Ih() {
      var e,
        ...
        r = ce ? Ga(de) : 0,
        i = ce ? Fa(de) : 0;
      (W && ((se.x = Rg(G, 'px') + 'px'), (se.y = Rg(K, 'px') + 'px'), se.renderTransform()),
        Hh(!1),
        (Ge.x = q.pointerX - r),
        (Ge.y = q.pointerY - i),
        k && k.apply(Ge, Ge),
    ...
    function Lh(e, t) {
      ...
      if (
        ...
        if (
          ...
          (F = !B && !q.allowEventDefault) && (Ba(e), za(me, 'touchforcechange', Ba)),
          e.changedTouches
      ...
      he = function setPointerPosition(e, t, n) {
        ...
        ((q.pointerX = e),
          ...
          Q
            ...
            : (k && ((s = e * k.a + t * k.c + k.e), (t = e * k.b + t * k.d + k.f), (e = s)),
              ...
              (q.lockAxis || q.lockedAxis) &&
                (o || r) &&
                ((s = q.lockedAxis) ||
                  ((q.lockedAxis = s = V && Math.abs(o) > Math.abs(r) ? 'y' : U ? 'x' : null),
          ...
          (A || C || N) &&
            ...
            C && (a = da(C(a)))),
          M &&
            (E < i ? (i = E + Math.round((i - E) * d)) : i < L && (i = L + Math.round((i - L) * d)),
            Q ||
              (S < a
          ...
          (q.x === i && (q.y === a || Q)) ||
            (Q
              ...
              : (U && ((q.y = q.endY = a), (Y = !0)), V && ((q.x = q.endX = i), (Y = !0))),
    ...
    return (
      ...
      (e.update = function (e, t, n) {
        ...
        return (
          ...
          q.isPressed &&
            !t &&
            ((V && 0.01 < Math.abs(a - q.x)) || (U && 0.01 < Math.abs(l - q.y) && !Q)) &&
            Ih(),
          q.autoScroll &&
            (La(h.parentNode, q.isDragging), (te = q.isDragging), zh(!0), Ia(h, Ph), Ha(h, Ph)),
          q
        );
      }),
      (e.enable = function (e) {
        ...
        if ('soft' !== e) {
          for (ta(J, null), o = J.length; -1 < --o; )
            ((t = J[o]),
              ...
              Aa(t, 'contextmenu', yh));
          (Wa(J, !0),
            v && (Aa(v, 'touchcancel', fe), Aa(v, 'touchend', fe), Aa(v, 'touchmove', ue)),
            Aa(de, 'mouseup', fe),
            Aa(de, 'mousemove', ue));
        }
        return (
